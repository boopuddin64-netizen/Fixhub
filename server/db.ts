...
function getInitialSeedData(): DatabaseSchema {
  ...
  // Technician Parts Catalog & Inventory
  const technicianParts: TechnicianInventoryItem[] = [
    {
      id: 'part_1',
      inventoryItemId: 'part_1',
      technicianId: 'usr_tech_1',
      partName: 'iPhone 13 OLED Display Panel (Original OEM)',
      ...
      priceHistory: [
        {
          priceNaira: 75000,
          version: 1,
          changedAt: oneMonthAgo,
          reason: 'Initial inventory registration',
        },
      ],
      partsUsedCount: 12,
      supplier: 'Apple Authorized Genuine Supply Hub',
    ...
    },
    {
      ...
      sku: 'SKU-APPL-SCR-0132',
      unitPriceNaira: 48000,
      priceNaira: 48000,
      currency: 'NGN',
      quantityOnHand: 8,
      inStockCount: 8,
      ...
      partsUsedCount: 24,
      supplier: 'JK Hard OLED Global Components',
      createdAt: oneMonthAgo,
      updatedAt: pastDate,
    },
    {
      id: 'part_3',
      inventoryItemId: 'part_3',
      technicianId: 'usr_tech_1',
      partName: 'iPhone 13 Original Capacity Battery (3240 mAh)',
      ...
      partsUsedCount: 18,
      supplier: 'Desay Original Battery Technologies',
      createdAt: oneMonthAgo,
      updatedAt: pastDate,
    },
    {
      id: 'part_4',
      inventoryItemId: 'part_4',
      technicianId: 'usr_tech_1',
      partName: 'Galaxy S23 Dynamic AMOLED 2X Screen Assembly',
      name: 'Galaxy S23 Dynamic AMOLED 2X Screen Assembly',
      category: 'Display / Screen',
      brand: 'Samsung',
      deviceBrand: 'Samsung',
      compatibleModels: ['Galaxy S23'],
      deviceModel: 'Galaxy S23',
      quality: 'ORIGINAL_OEM',
      sku: 'SKU-SAMS-SCR-0231',
      unitPriceNaira: 88000,
      priceNaira: 88000,
      currency: 'NGN',
      quantityOnHand: 3,
      inStockCount: 3,
      ...
      partsUsedCount: 5,
      supplier: 'Samsung Display Service Direct',
      createdAt: oneMonthAgo,
      updatedAt: pastDate,
    },
    {
      id: 'part_5',
      inventoryItemId: 'part_5',
      technicianId: 'usr_tech_2',
      partName: 'iPhone 14 Pro Original Retina XDR Screen',
      ...
      quality: 'ORIGINAL_OEM',
      sku: 'SKU-APPL-SCR-0141',
      unitPriceNaira: 145000,
      priceNaira: 145000,
      currency: 'NGN',
      quantityOnHand: 2,
      inStockCount: 2,
      ...
      partsUsedCount: 7,
      supplier: 'LG Display Pro Retina Parts',
      createdAt: oneMonthAgo,
      updatedAt: pastDate,
    },
    {
      id: 'part_6',
      inventoryItemId: 'part_6',
      technicianId: 'usr_tech_3',
      partName: 'Tecno Camon 30 Pro AMOLED Display',
      name: 'Tecno Camon 30 Pro AMOLED Display',
      category: 'Display / Screen',
      brand: 'Tecno',
      deviceBrand: 'Tecno',
      compatibleModels: ['Camon 30 Pro 5G', 'Camon 30 Pro'],
      deviceModel: 'Camon 30 Pro 5G',
      quality: 'ORIGINAL_OEM',
      sku: 'SKU-TECN-SCR-0301',
      ...
      partsUsedCount: 9,
      supplier: 'Carlcare Transsion Authorized Components',
      createdAt: oneMonthAgo,
      updatedAt: pastDate,
    },
  ];
